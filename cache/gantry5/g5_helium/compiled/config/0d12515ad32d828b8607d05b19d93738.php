...
return [
    ...
    'timestamp' => 1550709560,
    'checksum' => 'efd47096ecc6daaa1662bc738aa4d0ac',
    'files' => [
    ...
    'data' => [
        'index' => [
            ...
            'particles' => [
                'messages' => [
                    'system-messages-9900' => 'System Messages'
                ],
                'logo' => [
                    'logo-4521' => 'Logo / Image',
                    'logo-8228' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-3272' => 'Menu'
                ],
                ...
                'copyright' => [
                    'copyright-3037' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-6009' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-2297' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-1696' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    'navigation' => 'navigation',
                    'system-messages-9900' => 'system-messages-7972',
                    'logo-4521' => 'logo-9608',
                    'menu-3272' => 'menu-6409',
                    'social-4586' => 'social-3171',
                    'footer' => 'footer',
                    'logo-8228' => 'logo-9571',
                    'copyright-3037' => 'copyright-1736',
                    'horizontalmenu-6009' => 'horizontalmenu-9034',
                    'totop-2297' => 'totop-8670',
                    'offcanvas' => 'offcanvas',
                    'mobile-menu-1696' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
                ...
                'owlcarousel-2455' => [
                    ...
                    'attributes' => [
                        'items' => [
                            0 => [
                                'class' => '',
                                'image' => 'gantry-media://header/principal1.jpg',
                                'title' => '',
                                'desc' => '',
                                'link' => '',
                                'linktext' => '',
...
<div>Find out more about using the Layout Manager in our <a href="http://docs.gantry.org/gantry5/configure/layout-manager">documentation</a>.</div>',
    ...
    <div class="g-grid">
        ...
        'styles' => [
            ...
            'header' => [
                'background-image' => 'gantry-media://header/principal.jpg'
            ],
            'utility' => [
                'text-color' => '#ffffff'
            ],
